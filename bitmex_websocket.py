...
class BitMEXWebsocket():
    ...
    The Daxiang Trade still interacts with this as if it were a REST Endpoint, but now it can get
    much more realtime data without heavily polling the API.
    
    The Websocket offers a bunch of data as raw properties right on the object.
    On connect, it synchronously asks for a push of all this data then returns.
    Right after, the Daxiang Trade can start using its data. It will be updated in realtime, so the Daxiang Trade can
